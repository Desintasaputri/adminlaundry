                  <div class="x_panel">
                    <div class="x_title">
                      <h2><?php echo  $header_tambahmobil; ?> <small>Tambah Data Pelanggan</small></h2>
...
<?php  
 ...
 ?>
                  ...
                  <div class="x_content">
                    <br />
                    <form action="<?php echo base_url(). 'pelanggan/aksi_tambahdata'; ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype='multipart/form-data' method="post">
